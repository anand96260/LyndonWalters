...
if ($check2 == 0)
{
	$_SESSION['error']="User Does not exist. Please Check Login Deatils...";
}
while($info = mysql_fetch_array( $check ))
{
	...
	elseif ($info['auth']!=1){
		...
		$_SESSION['error']="wait for login authentication by admin";
	}else
	{
		...
		$hour = time() + 3600;
		setcookie(ID_my_site_walter, $_POST['email'], $hour);
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	<title>Lydon Walters - Admin LogIn</title>
...
<div id="bodyouter">
    ...
    <div id="leftcol" style="width:100%">
      ...
      <form id="form1" name="form1" method="post" action="adminlogin.php" >
        User Name:
          <input name="email" type="text" id="username" size="40" required />
        <br /><br />
        Password:
       <input name="pass" type="password" id="password" size="40" required />
       <br />
